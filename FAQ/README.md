...
All the platform incomes (affiliate, router and bridge fees) will redistributed to the staking module where $VULT stakers will earn it directly in $USDC, read more [here](../vultisig-token/vult/#utility-of-usdvult-token).
