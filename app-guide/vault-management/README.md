...
| Feature | Description |
|---------|-------------|
| [Vault Details](vault-details.md) | View signing parties and public keys |
| [Vault Backup](vault-backup.md) | Export vault shares for recovery |
| [Vault Rename](vault-rename.md) | Change the local vault name |
...
{% hint style="info" %}
**Verify your backups exist** — ensure you have backed up all vault shares at least once. After initial backup, you only need to create new backups after a [reshare operation](vault-reshare.md). See [Backup & Recovery](../../getting-started/backup-recovery.md) for best practices.
{% endhint %}
