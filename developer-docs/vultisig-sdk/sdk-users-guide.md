...
* [Installation & Setup](sdk-users-guide.md#installation--setup)
* [Quick Start Tutorial](sdk-users-guide.md#quick-start-tutorial)
* [Core Concepts](sdk-users-guide.md#core-concepts)
* [Password Management](sdk-users-guide.md#password-management)
* [Vault Management](sdk-users-guide.md#vault-management)
* [Creating Vaults from Seedphrase](sdk-users-guide.md#creating-vaults-from-seedphrase)
* [Essential Operations](sdk-users-guide.md#essential-operations)
* [Token Swaps](sdk-users-guide.md#token-swaps)
* [Token Registry & Discovery](sdk-users-guide.md#token-registry--discovery)
* [Price Feeds](sdk-users-guide.md#price-feeds)
* [Security Scanning](sdk-users-guide.md#security-scanning)
* [Fiat On-Ramp (Banxa)](sdk-users-guide.md#fiat-on-ramp-banxa)
* [Push Notifications](sdk-users-guide.md#push-notifications)
* [Configuration](sdk-users-guide.md#configuration)
* [Caching System](sdk-users-guide.md#caching-system)
* [Event System](sdk-users-guide.md#event-system)
* [Quick Reference](sdk-users-guide.md#quick-reference)
* [Platform Notes](sdk-users-guide.md#platform-notes)
...
See the [Quick Reference](sdk-users-guide.md#supported-chains) section for the complete list.
...
Custom adapters may share a backing store with application data. The SDK reserves `vault:*`, `pending:*`, `cache:*`, `addressBook:*`, `activeVaultId`, `pushNotificationRegistrations`, `config:defaultCurrency`, and `config:defaultChains`. `sdk.clearVaults()` removes the vault-scoped keys, saved and vault address-book entries, and local push registrations but intentionally retains the two SDK preference keys. The adapter's `clear()` method remains an explicit adapter-wide operation that may also remove unrelated host keys.
...
Passwords are cached to avoid repeated prompts (see [Password Management](sdk-users-guide.md#password-management)):
...
**Custom Storage**: For custom persistence needs, implement the `Storage` interface (see [Custom Storage Implementation](sdk-users-guide.md#custom-storage-implementation) for a full example).
