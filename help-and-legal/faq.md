---
description: 'Vultisig FAQ: vaults, backups, fees, signing, and recovery.'
---
...
Swaps charge a 50 bps Vultisig fee on top of the route's protocol and network fees. Hold $VULT in the vault to reduce that fee. Tiers are on [$VULT in-app fee discounts](../vult-token/vult/in-app-utility.md).
